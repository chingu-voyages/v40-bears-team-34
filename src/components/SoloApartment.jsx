...
const SoloApartment = ({ apartment }) => {
    return (
        <>
            <div className="transition ease-in delay-150 w-[90vw] md:w-[75vw] my-6  md:flex bg-[#FDEEDC] rounded-lg overflow-hidden mb-10 hover:cursor-pointer shadow-md hover:shadow-2xl  hover:scale-102">
                <img
                    src={apartment.image}
                    alt="image"
